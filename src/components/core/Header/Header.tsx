        ...
        <div className="flex items-center space-x-4">
          {user ? (
            ...
            <>
              <Link
                href={"/login"}
                className="px-4 py-2 bg-white border border-gray-800 text-gray-800 rounded-md text-lg hover:bg-gray-100"
              >
                Log In
              </Link>
              <Link
                href={"/register"}
                className="px-4 py-2 bg-gray-800 text-white rounded-md text-lg hover:bg-gray-900"
              >
                Get Started
              </Link>
            </>
