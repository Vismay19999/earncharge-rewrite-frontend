...
const WithdrawQR = () => {
  ...
  return (
    <div className="p-2">
      ...
      <p className='font-bold'>For Referral withdraw</p>
      <Button
        onClick={openModal}
        disabled={loading}
      >
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
            To withdraw the Referral, kindly click on the button below. This will take you to a new page and ask for your mobile number to fetch the UPI ID linked to that number. The Referral amount <p className="text-blue-600 font-bold"> (minimum ₹20)</p>  will be credited to your account in real-time.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
